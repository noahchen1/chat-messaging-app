  ...
  return (
    <div className="px-4 flex-1">
      {conversations?.map((conversation, idx) => (
        ...
        >
          <div className=" relative flex justify-center items-center flex-shrink-0 w-8 h-8 bg-gray-200 rounded-full text-lg font-semibold ">
